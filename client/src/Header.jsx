...
function Header() {
  ...
  return (         
    ...
    <div className="flex gap-2 border border-grey-300 rounded-full py-2 px-4 shadow-md shadow-grey-800">
      ...
      <div className="border-l border-grey-300"></div>
      <div>Add guest</div>
      <button className="bg-primary tex-white p-1 rounded-full ">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
      <path strokeLinecap="round" strokeLinejoin="round" d="m15.75 15.75-2.489-2.489m0 0a3.375 3.375 0 1 0-4.773-4.773 3.375 3.375 0 0 0 4.774 4.774ZM21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
      </svg>
      </button>
    </div>
      <Link  to={user?'/account': '/login'} className="flex items-center gap-2 border border-grey-300 rounded-full py-2 px-4 overflow-hidden">
